...
import { Cource } from '../ToDoList/addcource/addcource.component';
...
export class CourceService {
  ...
  constructor() { }
  public pushArray(){
    this.cource.push(JSON.parse(localStorage.getItem('cources') || '{}'));
  };
